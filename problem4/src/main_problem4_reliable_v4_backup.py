...
def main():
    ...
    parser.add_argument("--search", choices=("triangular", "compact", "baseline"), default="compact")
    ...
    with log_path.open("w", encoding="utf-8") as log, (log_dir / ("actions_reliable_" + stamp + ".jsonl")).open("w", encoding="utf-8") as actions:
        ...
        solver_class = {"triangular": TriangularSolver, "compact": CompactSolver, "baseline": ReliableSolver}[args.search]
